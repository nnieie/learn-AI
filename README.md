...
所有的考核相关文档遵循：学习目的 - 学习内容 - 学习要求（可能没有） - 作业 - 推荐教程与参考资料 - 作业要求 - 作业提交方式的目录结构编写。
...
考核大致分为两个阶段，Foundation 和 Science Research / Application。Foundation 是共通路线，在完成 foundation后，你需要从 Science Research 和 Application 两者里选择一个。

如果你想保研，未来想进实验室，那么建议选前者。

如果你未来想找工作，那么可以选择后者。

关于更具体的建议，以及为什么会有 Python Backend 和 Statistics，可以见 Foundation 文件夹的 task4.md，这是关于未来的导入。
